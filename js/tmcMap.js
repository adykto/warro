...
//(function($) {
	...
	Map.prototype.init = function() {
		...
		/*var img2,img3,img4;
		img2 = $("#i2");
		//img2.addClass('ncl-map-image');img2.fadeIn("fast");
		img3 = $("#i3");
		//img3.addClass('ncl-map-image');
		img4 = $("#i4");
		//img4.addClass('ncl-map-image');
		img2.fadeIn("fast");img3.fadeIn("fast");img4.fadeIn("fast");
		img2.removeAttr("display");img3.removeAttr("display");img3.removeAttr("display");img3.removeAttr("display");

										
		//.el = ".ncl-container"; 
		
		target.container.el.append(img2);
		target.container.el.append(img3);
		target.container.el.append(img4);*/
		
		this.el = $(this.img);//,img2,img3,img4);
